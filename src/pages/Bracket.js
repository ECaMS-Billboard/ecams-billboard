...
const Bracket = () => {
  ...
  // Initialize tournament only in browser
  useEffect(() => {
  ...
  // Advance round if a week has passed
  useEffect(() => {
    if (!state || state.tournamentEnded || typeof window === 'undefined') return;
